...
def inference_func(model, metrics_collector, cur_time, start_time_step, end_time_step):
    ...
    total_mrr, total_hit_1, total_hit_3, total_hit_10 = 0, 0, 0, 0
    ...
    time_length = end_time_step - start_time_step
    accumulative = {'mrr': total_mrr/time_length,'hit_1': total_hit_1/time_length,'hit_3': total_hit_3/time_length,'hit_10': total_hit_10/time_length}
    metrics_collector.update_eval_accumulated_metrics(accumulative)
...
if __name__ == '__main__':
    ...
    start_time_step = {'wiki': 54, "yago": 42, "icews14":292}[dataset]
